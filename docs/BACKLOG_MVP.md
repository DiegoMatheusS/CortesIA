...
| 3 Upload | Multipart até 5GB, formatos aprovados, max7h/4K server-side, histórico imediato, botões bloqueados; fila/outbox; YouTube metadata/restrições antes da confirmação; SSRF/rebinding e MIME falsos recusados; storage privado. | F1/F2 |
