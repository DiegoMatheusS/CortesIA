...
| 3 Upload | Multipart S3, formatos/tamanho/duração validados, **até 7 horas e 30 GB por arquivo**, upload/link, jobs/outbox/SQS, master privado, status e progresso granular até a UI | Retomar/cancelar upload pela interface, limites de concorrência por conta, benchmark de disco para fontes grandes, homologação real de YouTube/S3/SQS e políticas comerciais de importação |
...
O limite técnico é **7 horas** e o limite máximo de arquivo é **30 GB**. Em produção, vídeos acima de 90 minutos continuam dependentes de aprovação explícita da política comercial; em desenvolvimento/homologação é possível testar o pipeline longo sem esse bloqueio.
