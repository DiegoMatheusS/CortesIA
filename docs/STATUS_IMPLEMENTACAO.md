...
| 3 Upload | Multipart S3, formatos/tamanho/duração validados, **limite técnico de até 7 horas**, importação YouTube com feature flag, SSRF/DNS guard, retries, jobs/outbox/SQS, master privado, status e progresso granular até a UI | Retomar/cancelar upload pela interface, limite máximo de 30 GB, limites de concorrência por conta e smoke/homologação real de YouTube/S3/SQS no ambiente alvo |
